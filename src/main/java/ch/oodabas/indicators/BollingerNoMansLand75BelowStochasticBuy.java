...
class BollingerNoMansLand75BelowStochasticBuy {
    static Strategy get(final BarSeries series) {
        ...
        // Entry rule
        final Rule entryRule = new OverIndicatorRule(shortEma, longEma) // Trend new CrossedUpIndicatorRule(closePriceIndicator, nmlUP)
